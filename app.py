...
def create_app():
    ...
    def restore_inventory(cursor, product_name, quantity):
        cursor.execute(
            """
            UPDATE inventory
            SET stock = stock + %s
    ...
    def process_return():
        ...
        try:
            ...
            cursor.execute(
                ...
                SELECT quantity
                FROM order_items
                WHERE order_id = %s AND product_name = %s
                """,
            ...
            insert_cursor.execute(
                ...
                VALUES (%s, %s, %s, %s, %s)
                """,
                (order_id, product_name, quantity, reason, "Pending"),
            )

            restore_inventory(insert_cursor, product_name, quantity)
